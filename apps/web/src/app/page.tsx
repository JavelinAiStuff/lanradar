...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a href="/events" className="px-8 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-colors shadow-lg shadow-primary/25">
              Browse Events
            </a>
      ...
      {/* Latest Articles - NOW ABOVE EVENTS */}
      <section id="articles" className="py-24 px-6 border-t border-border/50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-10 rounded-xl overflow-hidden bg-card border border-border/50 hover:border-primary/30 transition-colors group cursor-pointer">
          ...
          {/* Article cards - larger */}
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {latestArticles.map((article) => (
              <div key={article.slug} className="rounded-xl bg-card border border-border/50 overflow-hidden hover:border-primary/30 transition-colors group cursor-pointer">
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 md:grid md:grid-cols-3 md:overflow-visible scrollbar-hide">
            {featuredEvents.map((event) => (
              <a
                ...
                className="min-w-[280px] md:min-w-0 p-5 rounded-xl bg-card border border-border/50 hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/5 group block"
              >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={f.title} className="p-6 rounded-xl bg-card border border-border/50 hover:border-primary/30 transition-colors group">
      ...
      <section id="newsletter" className="py-24 px-6 border-t border-border/50 bg-muted/30">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <form className="flex gap-3 max-w-md mx-auto" action="#">
            ...
            <button type="submit" className="px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-colors shadow-lg shadow-primary/25">
              Subscribe
            </button>
          </form>
